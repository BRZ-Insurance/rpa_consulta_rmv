    ...
    def run_rmv(self,vin,driver: webdriver.Chrome):
        ...
        while True:
            try:
                ...
                title = driver.find_elements(By.CSS_SELECTOR,'h3')[0].text
                while title != 'Search for a Vehicle':
                    try:
                ...
                try:
                    ...
                    dados_registration = DR(registration=registration)
